...
if len(sys.argv) == 1:
    ...
    print(
        "  swimmer.xml, hopper.xml, ant.xml, half_cheetah.xml, walker2d.xml, humanoid_symmetric.xml, humanoid.xml"
    )
    ...
    while 1:
        ...
        for i in range(len(paramIds)):
            ...
            p.setJointMotorControl2(
                robot, jointIds[i], p.POSITION_CONTROL, targetPos, force=5 * 240.0
            )
        time.sleep(0.01)
